...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { acuerdo: @promotion.acuerdo, client_id: @promotion.client_id, employee_id: @promotion.employee_id, fecha: @promotion.fecha, medioComunicacion: @promotion.medioComunicacion }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { acuerdo: @promotion.acuerdo, client_id: @promotion.client_id, employee_id: @promotion.employee_id, fecha: @promotion.fecha, medioComunicacion: @promotion.medioComunicacion }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
