...
class DetailSalesControllerTest < ActionController::TestCase
  ...
  test "should create detail_sale" do
    assert_difference('DetailSale.count') do
      post :create, detail_sale: { book_id: @detail_sale.book_id, cantidad: @detail_sale.cantidad, descuento: @detail_sale.descuento, precio: @detail_sale.precio, sale_id: @detail_sale.sale_id, total: @detail_sale.total }
    end
  ...
  test "should update detail_sale" do
    patch :update, id: @detail_sale, detail_sale: { book_id: @detail_sale.book_id, cantidad: @detail_sale.cantidad, descuento: @detail_sale.descuento, precio: @detail_sale.precio, sale_id: @detail_sale.sale_id, total: @detail_sale.total }
    assert_redirected_to detail_sale_path(assigns(:detail_sale))
  end
